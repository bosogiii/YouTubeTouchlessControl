...
def worker(input_q, output_q, boxes_q, inferences_q, cap_params, frame_processed):
    ...
    try:
        while True:
            ...
            if (frame is not None):
                ...
                box, res = detector.get_box_image(cap_params['num_hands_detect'], cap_params["score_thresh"], scores, boxes, cap_params['im_width'], cap_params['im_height'], frame)
